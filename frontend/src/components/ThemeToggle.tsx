  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className="fill-gray-800 peer-checked:opacity-60 absolute w-5 h-5 sm:w-6 sm:h-6 left-[12px]"
      >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-gray-800 opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-5 h-5 sm:w-6 sm:h-6 right-[12px]"
      >
